...
export default function AllTasksBoard() {
  ...
  }, [fetchTasks, fetchStatusDistribution]);
  ...
  return (
    <div className="flex flex-col h-full bg-zinc-950 text-zinc-100">
      ...
      <div className="flex-1 overflow-auto">
        {loading ? (
          <div className="p-6 text-center text-zinc-400">Loading tasks...</div>
        ) : tasks.length === 0 ? (
          <div className="p-6 text-center text-zinc-400">No tasks match your filters</div>
        ) : (
