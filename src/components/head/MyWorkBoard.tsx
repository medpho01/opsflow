  ...
  return (
    <div className="space-y-4">
      ...
      {/* Day progress line — replaces the misleading total badge. Open work
          ...
          (Supersedes main's old standalone OVERDUE section: that flat list
          is gone, replaced by the RECOVER TODAY zone below, which already
          groups overdue items into rule piles collapsed by default — a
          stronger fix for the same "don't dump hundreds of items open"
          problem main's defaultOpen={false} was solving.) */}
      <div>
